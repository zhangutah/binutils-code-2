...
CXXFLAGS_FOR_BUILD = -O1 -fno-omit-frame-pointer -gline-tables-only -DFUZZING_BUILD_MODE_UNSAFE_FOR_PRODUCTION -stdlib=libc++
CXX_FOR_BUILD = $(CXX)
...
M4 = m4
MAKEINFO = /src/binutils-2.38/missing makeinfo
EXPECT = expect
RUNTEST = runtest
...
CXXFLAGS_FOR_TARGET = -g -O2 -O1 -fno-omit-frame-pointer -gline-tables-only -DFUZZING_BUILD_MODE_UNSAFE_FOR_PRODUCTION -stdlib=libc++
